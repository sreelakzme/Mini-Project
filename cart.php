...
<form action="checkout.php?total=<?php echo $grandtotal?>&?pid=<?php echo $_SESSION['pid']?> " method="POST" name="cart" style="padding-left:880px;"><input type="submit" name="proceedcheckout" value="Proceed to Checkout" class="formbutton" style="width:250px;">
